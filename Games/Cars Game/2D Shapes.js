...
function Rect(pos, size, colour){
	...
	this.rectEnclosed = function(other){
		return (other.pos[0] > this.pos[0] && other.pos[1] > this.pos[1] && other.pos[0] + other.size[0] < this.pos[0] + this.size[0] && other.pos[1] + other.size[1] < this.pos[1] + this.size[1])
	}
